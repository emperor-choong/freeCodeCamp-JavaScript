...
For example, given `"10:00"`, return `"8ft west"` because 10am is 2 hours from noon, so $2^3$ = 8 feet, and the shadow points west because the sun is in the east at 10am.
